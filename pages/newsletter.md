...
title: "Newsletter"
subheadline: "Quarterly project updates"
...
<div class="ai4ed-pdf-viewer__actions">
  <a class="button radius" href="{{ '/assets/docs/llm4ed-quarterly-newsletter-q4-2025.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">Open Newsletter PDF</a>
</div>

<p class="ai4ed-pdf-viewer__fallback">If the embedded viewer does not load in your browser, use the button above to open the newsletter directly.</p>
